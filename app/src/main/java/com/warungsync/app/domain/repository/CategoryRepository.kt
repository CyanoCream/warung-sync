...
interface CategoryRepository {
    ...
    suspend fun addCategory(tokoId: String, namaKategori: String): Result<Category>
    suspend fun updateCategory(tokoId: String, id: String, namaKategori: String): Result<Category>
